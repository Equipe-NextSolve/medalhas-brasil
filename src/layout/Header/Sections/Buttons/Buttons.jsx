            ...
            <div className="flex items-center gap-2">
                ...
                <Link href="/contato" className="group hidden items-center gap-2.5 rounded-lg px-3 py-2 transition-all duration-200 hover:bg-gray/20 lg:flex">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[11px] font-medium leading-none text-darkGray">Precisa de ajuda?</span>

                        <span className="mt-1 text-sm font-semibold leading-none text-black">Atendimento</span>
                    </div>
                </Link>
                ...
                <button
                    ...
                    className="group flex cursor-pointer items-center gap-2 rounded-lg p-2.5 transition-all duration-200 hover:bg-gray/20">
                    <UserRound
                        size={21}
                        strokeWidth={1.8}
                    ...
                    <div className="hidden flex-col text-left xl:flex">
                        <span className="text-[11px] font-medium leading-none text-darkGray">Bem-vindo</span>

                        <span className="mt-1 text-sm font-semibold leading-none text-black">Entrar ou cadastrar</span>
                    </div>
                </button>
                ...
                <button
                    ...
                    <div className="hidden flex-col text-left xl:flex">
                        <span className="text-[11px] font-medium leading-none text-darkGray">Seu carrinho</span>
