...
export default function MedalAbout() {
    ...
    return (
        <section className="relative w-full min-h-screen flex items-center bg-white text-black py-20 md:py-28 overflow-hidden">

            {/* Efeitos sutis de luz de fundo usando a paleta oficial */}
            <div className="absolute w-100 md:w-175 h-100 md:h-175 bg-yellow/5 blur-[120px] md:blur-[160px] rounded-full -top-20 -left-20 pointer-events-none"></div>
            <div className="absolute w-75 md:w-150 h-75 md:h-150 bg-blue/4 blur-[100px] md:blur-[140px] rounded-full bottom-10 -right-20 pointer-events-none"></div>
            ...
            <div className="relative max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center z-10 w-full">
                ...
                >
                    <span className="text-yellow font-bold text-xs md:text-sm tracking-widest uppercase mb-2 block">
                    ...
                    <div className="w-20 h-1.5 bg-yellow rounded-full mt-4 mb-6"></div>

                    <div className="space-y-4 text-darkGray text-base md:text-lg leading-relaxed antialiased">
                        <p>
                    ...
                    <div className="pt-4 flex flex-col sm:flex-row gap-4">
                        <Link
                            href='/budget'
                            className="inline-flex items-center justify-center px-8 py-4 bg-yellow text-black font-bold rounded-xl shadow-md hover:bg-yellow/90 active:scale-[0.98] transition-all text-center"
                        >
                ...
                >
                    ...
                    >
                        ...
                        <motion.div variants={itemGrid} className="bg-white border border-gray/30 p-6 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300">
                            <div className="w-10 h-10 rounded-xl bg-yellow/10 flex items-center justify-center text-yellow font-bold text-base mb-4">
                                ★
                            </div>
                            <h3 className="text-lg font-bold text-black mb-1">Design Exclusivo</h3>
                        ...
                        {/* Bloco Diferencial 3 */}
                        <motion.div variants={itemGrid} className="bg-white border border-gray/30 p-6 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300">
                            <div className="w-10 h-10 rounded-xl bg-blue/10 flex items-center justify-center text-blue font-bold text-base mb-4">
                                🤝
                            </div>
                            <h3 className="text-lg font-bold text-black mb-1">Atendimento B2B</h3>
                            <p className="text-darkGray/80 text-sm leading-relaxed">
